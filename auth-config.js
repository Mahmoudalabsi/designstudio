 ...
 *
 *  ⚠️ تعطيل مؤقت:
 *  - حالياً تم تعطيل حماية الصفحات مؤقتاً (enabled: false) لسماح
 *    لموديل AI بالعمل على الموقع دون حاجة لكلمة مرور.
 *  - لإعادة التفعيل: غيّر `enabled` إلى `true` وأعد النشر.
 * ───────────────────────────────────────────────────────────
 */
window.AUTH_CONFIG = {
  // ⚠️ تعطيل/تفعيل المصادقة (لإعادة التفعيل: ضع true)
  enabled: false,
